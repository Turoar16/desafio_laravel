@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('Desafio')])
                    ...
                    <div class="card-body ">
                        ...
                        <div class="bmd-form-group{{ $errors->has('nombre') ? ' has-danger' : '' }}">
                            <div class="input-group">
                                ...
                                <input type="text" name="nombre" class="form-control" placeholder="{{ __('Name and Last Name...') }}"
