...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::delete('/ingresos/{ingreso}', [App\Http\Controllers\IngresoController::class, 'destroy'])->name('ingresos.delete');
    ...
    Route::delete('/gastos/{gasto}', [App\Http\Controllers\GastoController::class, 'destroy'])->name('gastos.delete');
